...
function love.conf(t)
	t.title = "Strike Online"		-- The title of the window the game is in (string)
	t.author = "Leszek Godlewski"	-- The author of the game (string)
	t.identity = "strike"			-- The name of the save directory (string)
